package at.acfhcampus.stud.team_garbagecan.Upgrades_8;
...
public abstract class Upgrade8 {
    ...
    public static List<Upgrade8> upgradeList = new ArrayList<>();                   //Erstellen einer Liste die bei der Erstellung eines neuen Upgrades dieses gleich in sich hinzufÃ¼gt
    private ShopItem8 shopItem;

    public Upgrade8(int clickpower, int amount, int cost, String name, String url) {
        this.clickpower = clickpower;
        this.amount = amount;
        this.cost = cost;
        this.name = name;
        upgradeList.add(this);                                                     //Fügt das erzeugte Upgrade in die erstellte Liste hinzu
        shopItem = new ShopItem8(new Image(url), this);                     //Pfad des Icons eines Upgrades
    }
