package at.acfhcampus.stud.team_garbagecan.Upgrades_5;
...
public abstract class Upgrade5 {
    ...
    public static List<Upgrade5> upgradeList = new ArrayList<>();                   //Erstellen einer Liste die bei der Erstellung eines neuen Upgrades dieses gleich in sich hinzufÃ¼gt
    private ShopItem5 shopItem;

    public Upgrade5(int clickpower, int amount, int cost, String name, String url) {
        this.clickpower = clickpower;
        this.amount = amount;
        this.cost = cost;
        this.name = name;
        upgradeList.add(this);                                                     //Fügt das erzeugte Upgrade in die erstellte Liste hinzu
        shopItem = new ShopItem5(new Image(url), this);                     //Pfad des Icons eines Upgrades
    }
